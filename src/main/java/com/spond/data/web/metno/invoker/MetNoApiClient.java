package com.spond.data.web.metno.invoker;
...
import com.spond.data.web.metno.invoker.auth.Authentication;
import com.spond.data.web.metno.invoker.auth.HttpBasicAuth;
import com.spond.data.web.metno.invoker.auth.HttpBearerAuth;
import com.spond.data.web.metno.invoker.auth.ApiKeyAuth;
...
@Component("com.spond.data.web.metno.invoker.MetNoApiClient")
public class MetNoApiClient {
    ...
    @Autowired
    public MetNoApiClient(RestTemplate restTemplate) {
    ...
    protected void init() {
        ...
        setUserAgent("Spond Weather API");
     ...
     */
    public MetNoApiClient setBasePath(String basePath) {
     ...
     * @return ApiClient this client
     */
    public MetNoApiClient setUserAgent(String userAgent) {
     ...
     * @return ApiClient this client
     */
    public MetNoApiClient addDefaultHeader(String name, String value) {
     ...
     * @return ApiClient this client
     */
    public MetNoApiClient addDefaultCookie(String name, String value) {
     ...
     * @return API client
     */
    public MetNoApiClient setDateFormat(DateFormat dateFormat) {
