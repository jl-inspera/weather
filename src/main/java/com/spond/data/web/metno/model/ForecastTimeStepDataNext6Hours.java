 ...
 */
@ApiModel(description = "Parameters with validity times over six hours. Will not exist for all time steps.")
@JsonPropertyOrder({
  ForecastTimeStepDataNext6Hours.JSON_PROPERTY_DETAILS,
  ForecastTimeStepDataNext6Hours.JSON_PROPERTY_SUMMARY
})
